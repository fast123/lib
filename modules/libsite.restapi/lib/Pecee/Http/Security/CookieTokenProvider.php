...
namespace LibSite\RestApi\Pecee\Http\Security;

use Exception;
use LibSite\RestApi\Pecee\Http\Security\Exceptions\SecurityException;
use function Pecee\Http\Security\setcookie;
