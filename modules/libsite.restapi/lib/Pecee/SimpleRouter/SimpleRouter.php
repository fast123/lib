...
use Closure;
use Exception;
use LibSite\RestApi\Pecee\Exceptions\InvalidArgumentException;
use LibSite\RestApi\Pecee\Http\Middleware\BaseCsrfVerifier;
use LibSite\RestApi\Pecee\Http\Request;
use LibSite\RestApi\Pecee\Http\Response;
use LibSite\RestApi\Pecee\Http\Url;
use LibSite\RestApi\Pecee\SimpleRouter\ClassLoader\IClassLoader;
use LibSite\RestApi\Pecee\SimpleRouter\Exceptions\HttpException;
use LibSite\RestApi\Pecee\SimpleRouter\Handlers\CallbackExceptionHandler;
use LibSite\RestApi\Pecee\SimpleRouter\Handlers\IEventHandler;
use LibSite\RestApi\Pecee\SimpleRouter\Route\IGroupRoute;
use LibSite\RestApi\Pecee\SimpleRouter\Route\ILoadableRoute;
use LibSite\RestApi\Pecee\SimpleRouter\Route\IPartialGroupRoute;
use LibSite\RestApi\Pecee\SimpleRouter\Route\IRoute;
use LibSite\RestApi\Pecee\SimpleRouter\Route\RouteController;
use LibSite\RestApi\Pecee\SimpleRouter\Route\RouteGroup;
use LibSite\RestApi\Pecee\SimpleRouter\Route\RoutePartialGroup;
use LibSite\RestApi\Pecee\SimpleRouter\Route\RouteResource;
use LibSite\RestApi\Pecee\SimpleRouter\Route\RouteUrl;
...
class SimpleRouter
{
     ...
     * Start routing
     *
     * @throws \LibSite\RestApi\Pecee\SimpleRouter\Exceptions\NotFoundHttpException
     * @throws \LibSite\RestApi\Pecee\Http\Middleware\Exceptions\TokenMismatchException
